public class Main {
 ...
 System.out.println("Hello JavaWorld and JavaDeveloper!");
        ...
        //task7 Вариант 1
        //РАСКОМИТИЛ И ИЗМЕНИЛ СТАРЫЙ ВАРИК ЧТОБЫ БЫЛИ ВИДНЫ ИЗМЕНЕНИЯ
        for (int day = 0; day < 31; day += 7) {
        System.out.println("Сегодня " + (day + 1) + "e число" + (day % 7 == 0 ? " и ещё и пятница отчётный день" : "рабочий день."));
        }

        System.out.println("***end of task7 option1***");
        System.out.println("===========================");

        //TASK 7 Вариант 2+ Без логики в sout
        for (int day = 0; day < 31; day += 7) {
        if (day % 7 == 0) {
        System.out.println("Сегодня пятница" + (day + 1) + "е число плюс пятница отчётный день");}
        }
        System.out.println("*** ВАРИАНТ БЕЗ ЛОГИКИ В  SOUT***");
        System.out.println("===========================");


        //task7 Вариант2
        //ОСТАВИЛ РАСКОМИТИННЫМ ВАРИАНТ РЕШЕНИЯ 2 ЧТОБЫ БЫЛИ ВИДНЫ ПОДХОДЫ К РЕШЕНИЮ
        ...
        System.out.println("***end of task 7 option2***");
        System.out.println("===========================");
